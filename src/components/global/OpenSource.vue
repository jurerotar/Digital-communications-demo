<template>
    <section class="bg-gray-700 overflow-hidden pt-4 lg:pt-0">
        <div class="container p-4 mx-auto grid grid-cols-1 md:grid-cols-2">
            <div class="w-full lg:my-20">
                <div
                    ...
                    <font-awesome-icon :icon="['fas', 'code-branch']" class="text-3xl"></font-awesome-icon>
                </div>
            ...
            <div class="w-full mt-32 relative">
                <font-awesome-icon :icon="['fab', 'github']"
                                   class="opn-src-icon text-gray-800 absolute left-auto opacity-40 lg:opacity-80"></font-awesome-icon>
            </div>
        </div>
    </section>
</template>
