<template>
    ...
    V spodnjem primeru se ti ponavljata na intervalu <span class = "font-semibold">2π</span>, za kar po krožnici potrebujemo narediti 360 stopinj ali <span class = "font-semibold">2π</span> radianov.
    <br><br>
