<template>
  <div :style="{width: g_width, maxWidth: g_width}">
    <canvas
      :id="title"
      :width="g_width"
      :height="g_height"
...
export default {
  ...
  methods: {
    test() {
      setup(this.title, this.g_width, this.g_height, this.o_x, this.o_y, this.m_width, this.m_height, this.animation, this.animation_loop, this.X_label, this.Y_label);
