<template>
    ...
    <br><br>
    in na prvem grafu
    opazimo, da se razteza čez več period vzorčenja <span class="font-semibold">t<sub>s</sub></span>. Vnaša tudi zakasnitev <span class="font-semibold">t<sub>s</sub></span>, 
    ki je določena kot čas, ob katerem ima <span class="font-semibold">h(t)</span> največjo vrednost.
    <br><br>Izvorni signal je vsota časovno zamaknjenih impulzov <span class="font-semibold">g(t)</span>, uteženimi s simboli 
    ...
    <br><br><span
      ...
      class="katex-inline"
    /><br><br>
    kjer je <span class="font-semibold">v<sub>δ</sub>(t)</span> vzorčevalna funkcija (niz enotskih impulzov) s frekvenco <span class="font-semibold">f<sub>v</sub> = f<sub>s</sub></span>, 
