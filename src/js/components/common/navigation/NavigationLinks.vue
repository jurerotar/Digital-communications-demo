...
import {faWaveSquare, faWater, faLongArrowAltUp, faHome, faSignal, faEquals} from "@fortawesome/free-solid-svg-icons";
import {useRoute} from "vue-router";

library.add(faWaveSquare, faLongArrowAltUp, faHome, faWater, faSignal, faEquals);
