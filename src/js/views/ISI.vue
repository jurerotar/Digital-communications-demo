    ...
    methods: {
        ...
        nextBinaryValue() {
            if (this.binaryCounter === (this.binarySymbolLength-1)) {
                this.combinationsSequence.idx = this.combinationsSequence.idx === (this.combinationsSequence.values.length - 1) ? 0 : this.combinationsSequence.idx + 1;
        ...
        updatetransferFunction(){
            ...
            this.transferFunction = this.transferFunction.map((i,t) => Math.sin(2*Math.PI*fCut*multi*(t-tOffset))/(2*Math.PI*fCut*multi*(t-tOffset)))
