    ...
    this.p5 = new P5((p5) => {
      ...
      p5.draw = () => {
        ...
        this.$c.temporaryState(p5, () => {
          ...
          this.$c.widerLine(p5, 0, canvasDimensions.y - canvasPadding, canvasDimensions.x - 2 * canvasPadding, canvasDimensions.y - canvasPadding, 0.25);
          this.$c.widerLine(p5, 0, canvasPadding + 0.33 * (canvasDimensions.y - 2 * canvasPadding), canvasDimensions.x - 2 * canvasPadding, canvasPadding + 0.33 * (canvasDimensions.y - 2 * canvasPadding), 0.25);
          this.$c.widerLine(p5, 0, canvasPadding + 0.66 * (canvasDimensions.y - 2 * canvasPadding), canvasDimensions.x - 2 * canvasPadding, canvasPadding + 0.66 * (canvasDimensions.y - 2 * canvasPadding), 0.25);
