<template>
  <AppMainContainer>
    <AppMainHeading>Kazalci</AppMainHeading>
    <AppCollapsible>
      <PointersTheory />
    </AppCollapsible>
    <CanvasContainer>
  ...
  p5.value = new p5Extended(
    (p5) => {
      ...
      p5.draw = () => {
        ...
        // Marks
        p5.drawMarks(marks, shapeColor);

        // Axis
        p5.drawWith({ strokeWeight: 2 }, () => {
          p5.line(0, centerOffset, p5.canvasSize.width, centerOffset);
          p5.line(centerOffset, 0, centerOffset, p5.canvasSize.height);
        });
        ...
        p5.drawDashed(() => {
          p5.line(277, 0, 277, p5.canvasSize.height);
          p5.line(0, 277, p5.canvasSize.width, 277);
          p5.line(23, 0, 23, p5.canvasSize.height);
          p5.line(0, 23, p5.canvasSize.width, 23);
        });
        ...
        p5.drawWith({ strokeWeight: 3 }, () => {
          ...
          p5.drawWith({ stroke: p5.colors[1] }, () => {
            ...
            // Draw a pointer from middle to radius
            p5.arrowLine(p5.createVector(0, 0), p5.createVector(x, y));
